...
DB_URL = os.environ.get("DB_URL", "mongodb+srv://sa8619:mongodb+srv://hamzann:hamza00@cluster0.id2lo.mongodb.net/")
#your database name
...
FORCE_MSG = os.environ.get("FORCE_MSG", "Hello {mention}\n\n<b>You need to join in my Channel to use me\n\nKindly Please join Channel</b>")
#custom caption 
